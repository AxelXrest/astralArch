...
export default () => {
    ...
    const logoutButton = SessionButton('Logout', 'logout', () => { App.closeWindow('session'); execAsync(['swaylock']) });
    ...
    const hibernateButton = SessionButton('Hibernate', 'downloading', () => { App.closeWindow('session'); execAsync('swaylock') });
