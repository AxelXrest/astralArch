...
const WorkspaceContents = (count = 7) => {
    return DrawingArea({
        ...
        attribute: {
            ...
            workspaceGroup: 0,
            updateMask: (self) => {
                const offset = Math.floor((Hyprland.active.workspace.id - 1) / count) * 7;
...
export default () => EventBox({
    ...
    setup: (self) => {
        ...
        self.on('motion-notify-event', (self, event) => {
            ...
            const wsId = Math.ceil(cursorX * 7 / widgetWidth);
